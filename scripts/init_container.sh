...
RATES="bunny_2133691bps/ bunny_2484135bps/ bunny_3078587bps/ bunny_3526922bps/ bunny_3840360bps/ bunny_4219897bps/ bunny_2000kbit/ bunny_2500kbit bunny_3000kbit/ bunny_3500kbit/ bunny_4000kbit/ bunny_4500kbit/ bunny_5000kbit/"
...
install_software() {
    ...
    echo "deb http://$SERVER/dists xenial/" > /etc/apt/sources.list.d/icn-repo.list
    echo "# deb-src http://$SERVER/dists xenial/" >> /etc/apt/sources.list.d/icn-repo.list
...
#    apt-add-repository -y ppa:canonical-qt5-edgers/qt5-proper
    ...
    ndn-dissect-wireshark ndn-autoconfig-server cmake iperf3 ndn-icp-download libndn-icp ndn-virtual-repo  \
    repo-ng libnl-3-dev libnl-route-3-dev
#    vlc-plugin-ndn qtmultimedia5-dev qtbase5-dev libqt5widgets5 libqt5core5a libqt5gui5 libqt5multimedia5 \
